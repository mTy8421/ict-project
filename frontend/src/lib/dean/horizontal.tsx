    ...
    (month) =>
      dataResponse.filter(
        (item: any) =>
          ...
          (item.user.user_role === "หัวหน้างานฝ่ายบริหารทั่วไป" &&
    ...
    (month) =>
      dataResponse.filter(
        (item: any) =>
          ...
          (item.user.user_role === "หัวหน้างานฝ่ายวิชาการ" &&
            new Date(item.dateTimeNow).toLocaleString("th-TH", {
              month: "long",
            }) === month &&
            new Date(item.dateTimeNow).getFullYear() ===
    ...
    (month) =>
      dataResponse.filter(
        (item: any) =>
          ...
          (item.user.user_role === "หัวหน้างานฝ่ายแผนงาน" &&
            new Date(item.dateTimeNow).toLocaleString("th-TH", {
              month: "long",
            }) === month &&
            new Date(item.dateTimeNow).getFullYear() ===
    ...
    (month) =>
      dataResponse.filter(
        (item: any) =>
          ...
          (item.user.user_role === "หัวหน้างานฝ่ายพัฒนาทักษะดิจิทัล" &&
            new Date(item.dateTimeNow).toLocaleString("th-TH", {
              month: "long",
            }) === month &&
            new Date(item.dateTimeNow).getFullYear() ===
