...
const ViceDeanStrategyDashboard: React.FC = () => {
        ...
        <Sider width={200} style={{ background: '#fff' }}>
          ...
          >
            <Menu.Item key="1" icon={<BarChartOutlined />}>
              <Link to="/vice-dean/strategy">ภาพรวม</Link>
            </Menu.Item>
            <Menu.Item key="2" icon={<FileTextOutlined />}>
              <Link to="/vice-dean/strategy/workload">จัดการภาระงาน</Link>
            </Menu.Item>
            <Menu.Item key="3" icon={<UserOutlined />}>
              <Link to="/vice-dean/strategy/users">จัดการผู้ใช้</Link>
            </Menu.Item>
          </Menu>
        </Sider>
...
export default ViceDeanStrategyDashboard; 