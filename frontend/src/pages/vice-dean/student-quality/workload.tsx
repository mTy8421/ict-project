...
const ViceDeanStudentQualityWorkload: React.FC = () => {
  ...
  const columns = [
    {
      ...
      render: (text: string, record: Workload) => (
        <a onClick={() => navigate(`/vice-dean/student-quality/workload/${record.id}`)}>{text}</a>
      ),
    },
    {
      title: 'แผนก',
    ...
    },
    {
      ...
      render: (_: any, record: Workload) => (
        <Space size="middle">
          <Button type="link" onClick={() => navigate(`/vice-dean/student-quality/workload/${record.id}/edit`)}>
            แก้ไข
          </Button>
          ...
          <Content style={{ 
            ...
            <div style={{ 
              ...
              <Button
                type="primary"
                icon={<PlusOutlined />}
                onClick={() => navigate('/vice-dean/student-quality/workload/new')}
                style={{
...
export default ViceDeanStudentQualityWorkload; 