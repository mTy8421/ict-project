...
const StudentQualityViceDeanWorkload: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axiosInstance.get('/workload/department/ฝ่ายงานพัฒนาทักษะดิจิทัล');
  ...
  // ข้อมูลสำหรับกราฟ
  const workloadData = [
    { department: 'ฝ่ายงานพัฒนาทักษะดิจิทัล', count: data.length },
  ];
    ...
    <Layout style={{ minHeight: '100vh' }}>
      <Header style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 24px' }}>
        ...
        <div style={{ color: 'white' }}>
          <span>รองคณบดีฝ่ายคุณภาพนิสิต</span>
      ...
      <Layout>
        <Sider width={200} style={{ background: '#fff' }}>
          ...
          >
            <Menu.Item key="1">
              <Link to="/vice-dean/student-quality">หน้าหลัก</Link>
            </Menu.Item>
            <Menu.Item key="2">
              <Link to="/vice-dean/student-quality/workload">ภาระงาน</Link>
            </Menu.Item>
          </Menu>
        </Sider>
          ...
          <Content style={{ background: '#fff', padding: 24, margin: 0, minHeight: 280 }}>
            ...
            <Space style={{ marginBottom: 16 }}>
              ...
              >
                ...
                <Option value="ฝ่ายงานพัฒนาทักษะดิจิทัล">ฝ่ายงานพัฒนาทักษะดิจิทัล</Option>
              </Select>
            </Space>
...
export default StudentQualityViceDeanWorkload; 