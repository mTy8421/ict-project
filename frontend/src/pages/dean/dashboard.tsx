...
import { Card, Typography, Layout, Row, Col, Statistic, Progress, List, Tag } from 'antd';
...
const DeanDashboard: React.FC = () => {
  ...
  const inProgressWorkloads = workloads.filter(w => w.status === 'in_progress').length;
  const pendingWorkloads = workloads.filter(w => w.status === 'pending').length;

  const completionRate = totalWorkloads > 0 ? (completedWorkloads / totalWorkloads) * 100 : 0;
              ...
              <Col xs={24} sm={8}>
                ...
                >
                  <Statistic
                    ...
                    prefix={<ClockCircleOutlined style={{ color: theme.primary }} />}
                    valueStyle={{ color: theme.primary }}
                  />
                </Card>
              </Col>
              <Col xs={24} sm={8}>
                ...
                >
                  <Statistic
                    ...
                    prefix={<CheckCircleOutlined style={{ color: theme.primary }} />}
                    valueStyle={{ color: theme.primary }}
                  />
                </Card>
              </Col>
                  ...
                  <div style={{ marginTop: theme.spacing.lg }}>
                    ...
                    <div style={{ display: 'flex', gap: theme.spacing.lg }}>
                      <div>
                        ...
                        <Text strong style={{ display: 'block', color: theme.warning }}>
                          {pendingWorkloads} รายการ
                        </Text>
                      </div>
                      <div>
                        <Text type="secondary">กำลังดำเนินการ</Text>
                        <Text strong style={{ display: 'block', color: theme.primary }}>
                          {inProgressWorkloads} รายการ
                        </Text>
                      </div>
                      <div>
                        <Text type="secondary">เสร็จสิ้น</Text>
                        <Text strong style={{ display: 'block', color: theme.success }}>
